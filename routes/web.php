...
Route::post('/profils/{id}', [ProfilController::class, 'update'])->name('profil.update');
...
Route::post('/kategoris/{id}', [KategoriController::class, 'update'])->name('kategori.update');
...
Route::post('/hargas/{id}', [HargaPaketController::class, 'update'])->name('hargapaket.update');
...
Route::post('/faqs/{id}', [FAQController::class, 'update'])->name('admin.faq.update');
Route::get('/faqs/{id}/delete', [FAQController::class, 'destroy'])->name('admin.faq.destroy');
